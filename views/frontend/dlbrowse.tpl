	...
	{foreach from=$results item=result}
		<tr class="{cycle values=",alt"}">
			...
			<td>
				...
				{/if}
                {if $result.release.tvinfo_cover == 1}
                    <img width="120" class="shadow" alt="{$result.release.showtitle} Logo" src="{$smarty.const.WWW_TOP}/covers/tv/{$result.release.tvinfoID}.jpg" />
				{/if}				
