...
{/if}
	...
	<div class="control-group">
		<label class="control-label" for="tvinfoID">Tv Info Id</label>
		<div class="controls">
			<input class="input input-xxlarge" id="tvinfoID" class="short" name="tvinfoID" type="text" value="{$release.tvinfoID}" />
		</div>
	</div>
