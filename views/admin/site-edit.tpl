...
<form class="form-horizontal" action="{$SCRIPT_NAME}?action=submit" method="post">
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="lookuptvmaze">Lookup TV Maze</label>
			<div class="controls">
				{html_radios id="lookuptvmaze" name='lookuptvmaze' values=$yesno_ids output=$yesno_names selected=$fsite->lookuptvmaze separator=''}
				<span class="help-block">Whether to attempt to lookup tv maze on the web when processing.</span>
			</div>
		</div>
