...
<ul class="navigator">
	<li class="active">TVInfo List<span class="divider">/</span></li>
	<li><a href="{$smarty.const.WWW_TOP}/tvinfo-list.php">View</a><span class="divider">/</span></li>
	<li><a style="padding:0;" href="{$smarty.const.WWW_TOP}/tvinfo-edit.php?action=add">Add</a></li>
</ul>
