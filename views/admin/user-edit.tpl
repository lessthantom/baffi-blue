...
<form class="form-horizontal" action="{$SCRIPT_NAME}?action=submit" method="POST">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="musicview" name="musicview" type="checkbox" value="1" {if $user.musicview=="1"}checked="checked"{/if} />
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="consoleview" name="consoleview" type="checkbox" value="1" {if $user.consoleview=="1"}checked="checked"{/if} />
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="bookview" name="bookview" type="checkbox" value="1" {if $user.bookview=="1"}checked="checked"{/if} />
		</div>
	</div>
